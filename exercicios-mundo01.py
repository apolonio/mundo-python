...
5) 29 - Radar Eletronico: Se ultrapassar 80 foi mutado e custa 7 reais por km rodado senao nao mostra nada.
...
6) 30 - Crie um programa que passado um numo inteiro dizer se é par ou impar.

numero = int(input("Digite um numero: "))
resultado = numero % 2
print("O Resultado foi {}".format(resultado))

7) 31 - Viajens ate 200km paga por km  0,45 senao paga 0,5
...
9) 33 - Leia tres números e diga o menor, maior e MemoryBIO

10) 34 - Salario ate 1250 aumenta 10 %, senao aumenta 15%

11) 35 - Desenvolva um programa que dado 3 valores ele diz se é possível formar um triângulo!

15) 65 - Crie um programa que leia varios numeros inteiros pelo teclado, No final da execucao
. Mosre a media entre todos os valores e qual foi o maior e o menor valores lidos. O programa deve 
